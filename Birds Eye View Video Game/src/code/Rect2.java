...
public class Rect2
{
	...
	public Rect2(int x, int y, int w, int h, Color c)
	{
		this(x, y, w, h);
	...
	public boolean isLeftOf(Rect2 r)
	{
		return x < r.x - w + 1;
	}
	public boolean isRightOf(Rect2 r)
	{
		return x > r.x + r.w - 1;
	}
	
	public boolean isAbove(Rect2 r)
	{
		return y < r.y - h + 1;
	}
	
	public boolean isBelow(Rect2 r)
	{
		return y > r.y + r.h - 1;
	}
	
	public void chase(Rect2 r, int speed)
	{
	...
	/*if (overlaps(r)) {
	   ...
	   public boolean shouldStartChasing(Rect2 playerRect, int distanceThreshold) {
	   ...
	   public void moveTowardsPlayer(Rect2 playerRect, double speed) {
	   ...
	   public void shootPastPlayer(Rect2 playerRect, double speed) {
	...
	public boolean wasLeftOf(Rect2 r)
	{
		return x - vx < r.x - w + 1;
	}
	
	public boolean wasRightOf(Rect2 r)
	{
		return x - vx > r.x + r.w - 1;
	}
	
	public boolean wasAbove(Rect2 r)
	{
		return y - vy < r.y - h + 1;
	}
	
	public boolean wasBelow(Rect2 r)
	{
		return y - vy > r.y + r.h - 1;
	}
	
	public void pushedOutOf(Rect2 r)
	{
	...
	public void pushLeftOf(Rect2 r)
	{
		x = r.x - w - 1;
	}
	
	public void pushRightOf(Rect2 r)
	{
		x = r.x + r.w + 1;
	}
	
	public void pushAbove(Rect2 r)
	{
		y = r.y - h - 1;
	}
	
	public void pushBelow(Rect2 r)
	{
		y = r.y +  r.h + 1;
	}
	...
	public boolean standingOnAny(Rect2[] r)
	{
